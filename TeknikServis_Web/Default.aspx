...
<body>
    <div class="sidenav">
		...
		<div class="col-4 side_top_right">
			<img src="web/images/TeknikServis.png" alt="news image" class="img-fluid navimg">
		</div>
        ...
        <div class="banner-text-w3ls">
            <div class="container">
                <div class="mx-auto text-center">
                    <h1>En Ucuz Fiyatlarla En Uygun Binlerce Ürün Bir Tıkla Kapınızda</h1>
					<p class="banp mx-auto mt-3">Yüzlerce farklı kategoride Binlerce Ürünle Hizmetinizdeyiz</p>
...
<section class="slide-wrapper" id="about">
	...
	<p class="iner mt-5"> <asp:Repeater ID="Repeater1" runat="server">
        <ItemTemplate>
            <%# Eval("METIN") %>
        </ItemTemplate>
	    </asp:Repeater>
    ...
    <div class="wthree_pvtits-services align-w3" id="services">
        <div class="container">
            <div class="wthree_pvt_title text-center">
                ...
                <p class="main_p mb-5  text-center mx-auto">Mağazamızdan almış olduğunuz ürünlerde herhangi bir teknik proglem oluşursa 
                    2 yıl süreyle herhangi bir ücret ödemeden tamir ve onarım işlemlerini yapmaktayız
                </p>
                <a class="btn btn-primary mt-lg-5 mt-3 agile-link-bnr" href="WebForm1.aspx" role="button" style="background-color:darkgray">Arızalı Ürün Takibi</a>
            </div>
            <div class="wthree_pvtits-services-row row">
                ...
                <div class="col-lg-4 col-md-6 wthree_sgrid  py-sm-5 py-4">
                    ...
                    <h4 class="my-3"> Değişim Hakkı </h4>
                </div>
                <div class="col-lg-4 col-md-6 wthree_sgrid  py-sm-5 py-4">
                    <span class="fa fa-camera p-sm-4 p-2"></span>
                    <h4 class="my-3"> 7/24 Görüntülü İletişim</h4>
                </div>
                <div class="col-lg-4 col-md-6 wthree_sgrid   py-sm-5 py-4">
                    <span class="fa fa-bell-o p-sm-4 p-2"></span>
                    <h4 class="my-3"> 7/24 Bilgilendirme </h4>
                </div>
                <div class="col-lg-4 col-md-6  wthree_sgrid  py-sm-5 py-4">
                    <span class="fa fa fa-smile-o p-sm-4 p-2"></span>
                    <h4 class="my-3"> Müşteri Memnuniyeti </h4>
                </div>
                <div class="col-lg-4 col-md-6  wthree_sgrid   py-sm-5 py-4">
...
<!-- contact -->
	 <section class="wedo" id="contact">
		   ...
		   <p class="main_p mb-5  text-center mx-auto">Mağazamız ya da aldığınız herhangi bir ürüne dair bir sorununuz varsa bize aşağıdaki panelden mesaj göndererek ulaşabilirsiniz Mailinize en kısa sürede dönüş sağlanacaktır</p>
